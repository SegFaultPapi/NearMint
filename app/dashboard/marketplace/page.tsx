...
const marketplaceItems = [
  {
    ...
    year: "1999",
    condition: "Near Mint",
    description: "First Edition Charizard from Base Set, PSA 9 condition"
  },
  {
    id: "2",
    name: "Lionel Messi Rookie Card",
    category: "Soccer",
    price: 7800,
    ...
    year: "2004",
    condition: "Mint",
    description: "FC Barcelona rookie card, authenticated by PSA"
  },
  {
    id: "3",
    name: "Pink Floyd Autographed Copy",
    category: "Music",
    price: 3500,
    ...
    year: "1973",
    condition: "Excellent",
    description: "Dark Side of the Moon vinyl with band signatures"
  },
  {
    id: "4",
    ...
    year: "1993",
    condition: "Near Mint",
    description: "Alpha edition Black Lotus, one of the most valuable MTG cards"
  },
  {
    id: "5",
    ...
    year: "1986",
    condition: "Near Mint",
    description: "Fleer Michael Jordan rookie card, PSA authenticated"
  },
  {
    id: "6",
    name: "Charizard Base Set #4 (Duplicate)",
    category: "Pokemon",
    price: 3800,
    image: "/images/card-1.png",
    seller: "0x6e4d...1c9a",
    ...
    year: "1999",
    condition: "Excellent",
    description: "Second Charizard from Base Set, slightly lower grade"
  },
  {
    id: "7",
    name: "Lionel Messi Rookie Card (PSA 10)",
    category: "Soccer",
    price: 9500,
    image: "/images/card-2.png",
    seller: "0x7f8a...9b2c",
    ...
    year: "2004",
    condition: "Gem Mint",
    description: "Perfect grade Messi rookie card, PSA 10 condition"
  },
  {
    id: "8",
    name: "Black Lotus Beta",
    category: "Magic",
    price: 8500,
    image: "/images/card-4.png",
    seller: "0x4c2e...8d1f",
    ...
    year: "1993",
    condition: "Near Mint",
    description: "Beta edition Black Lotus, highly sought after"
  },
  {
    id: "9",
    ...
    year: "1986",
    condition: "Near Mint",
    description: "Fleer Jordan rookie in excellent condition"
  },
  {
    id: "10",
    name: "Pink Floyd The Wall Autographed",
    category: "Music",
    price: 2800,
    image: "/images/card-3.jpg",
    seller: "0x5d7c...4e9a",
    ...
    year: "1979",
    condition: "Very Good",
    description: "The Wall album with Roger Waters signature"
  },
  {
    id: "11",
    name: "Charizard Base Set #4 (Shadowless)",
    category: "Pokemon",
    price: 6500,
    image: "/images/card-1.png",
    seller: "0x8b2f...6c4d",
    ...
    year: "1999",
    condition: "Near Mint",
    description: "Shadowless Charizard, extremely rare variant"
  },
  {
    id: "12",
    ...
    year: "1993",
    condition: "Near Mint",
    description: "Unlimited edition Black Lotus, still highly valuable"
  }
]
